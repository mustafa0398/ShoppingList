...
/**
 * Using this interface, all data storage tasks should be performed.
 * <p>
 * The interface should be implemented by you using SharedPreferences as data storage technique,
 * with the help of the static functions provided in the `Utilities` class (which help to convert
 * data objects to strings and vice versa).
 */
